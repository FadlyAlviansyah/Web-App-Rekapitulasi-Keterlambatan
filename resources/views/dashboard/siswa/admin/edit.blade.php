  ...
  <header class="mb-3">
    ...
    <div class="card">
      <div class="card-content">
        <div class="card-body">
          <form class="form form-vertical" action="{{ route('siswa.update', $student['id']) }}" method="post">
            @csrf
            @method('PATCH')
            <div class="form-body">
              <div class="row">
                <div class="col-12">
                  <div class="form-group">
                    ...
                    <input type="text" id="nis" class="form-control @error('nis') is-invalid @enderror" value="{{ $student['nis'] }}" name="nis">
                    @error('nis')
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" id="name" class="form-control @error('name') is-invalid @enderror" value="{{ $student['name'] }}" name="name">
                    @error('name')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
