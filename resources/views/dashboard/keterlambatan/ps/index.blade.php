    ...
    <div class="card">
      <div class="card-content">
        <div class="card-body">
          ...
          @endif
          <a class="btn btn-info text-white" href="{{ route('ps.keterlambatan.export-excel') }}">Export Data Keterlambatan</a>
                  ...
                  <tbody>
                    ...
                    @foreach ($students as $item)
                      <tr>
                        ...
                        <td><a href="{{ route('ps.keterlambatan.detail', $item['id']) }}" class="text-decoration-none">Lihat</a></td>
                        <td>
                          @if ($item['late']->count() >= 3)
                            <a href="{{ route('ps.keterlambatan.download', $item['id']) }}" class="btn btn-primary">Cetak Surat Pernyataan</a>
                          @endif
                        </td>
                      </tr>
                    @endforeach
